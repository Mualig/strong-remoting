...
HttpContext.prototype.resolveReponseOperation = function(accepts) {
  ...
  switch (accepts) {
    ...
    case 'application/vnd.api+json':
      ...
      break;
    case 'application/vnd.fmsstandard.com.Vehicles.v2.1+json':
      result.contentType = 'application/vnd.fmsstandard.com.Vehicles.v2.1+json';
      break;
    case 'application/vnd.fmsstandard.com.VehicleStatuses.v2.1+json':
      result.contentType = 'application/vnd.fmsstandard.com.VehicleStatuses.v2.1+json';
      break;
    case 'application/vnd.fmsstandard.com.VehiclePositions.v2.1+json':
      result.contentType = 'application/vnd.fmsstandard.com.VehiclePositions.v2.1+json';
      break;
    ...
    case 'xml':
      ...
      break;
    case 'application/vnd.fmsstandard.com.Vehicles.v2.1+xml':
      result.contentType = 'application/vnd.fmsstandard.com.Vehicles.v2.1+xml';
      result.sendBody = sendBodyXml;
      break;
    case 'application/vnd.fmsstandard.com.VehicleStatuses.v2.1+xml':
      result.contentType = 'application/vnd.fmsstandard.com.VehicleStatuses.v2.1+xml';
      result.sendBody = sendBodyXml;
      break;
    case 'application/vnd.fmsstandard.com.VehiclePositions.v2.1+xml':
      result.contentType = 'application/vnd.fmsstandard.com.VehiclePositions.v2.1+xml';
      result.sendBody = sendBodyXml;
      break;
    default:
